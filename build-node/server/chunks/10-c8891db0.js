...
const Photo_component = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="container svelte-19xmq8a" id="${"photo-" + escape(id, true)}"><img id="img"${add_attribute("src", regular, 0)}${add_attribute("alt", alt_description, 0)} class="svelte-19xmq8a">
...
const index = 10;
const component = async () => (await import('./_page.svelte-b18566fc.js')).default;
...
const imports = ["_app/immutable/nodes/10.a62d6ad0.js","_app/immutable/chunks/index.fc594a95.js"];
const stylesheets = ["_app/immutable/assets/10.862fd1aa.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets, _page as universal, universal_id };
//# sourceMappingURL=10-c8891db0.js.map
